...
2.Дан массив строк (не пустой). Написать метод, возвращающий карту Map<String, Boolean>
где вся строка является ключем, а значением является true, если строка в массиве
встречается больше одного раза и false, если только один раз.
        ...
        " ]) → {"с": правда}
       3.Дан список имен, где повторяются некоторые имена. Написать метод, который по имени возвращает количество вхождений этого имени в список.
